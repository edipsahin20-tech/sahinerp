...
BEGIN
    ...
    VALUES (N'00000000000000_CreateIdentitySchema', N'10.0.10');
END;
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260727172906_InitialIdentity'
)
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260727172906_InitialIdentity', N'10.0.10');
END;
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260727182158_AddCatalogAndWebsiteProducts'
)
BEGIN
...
BEGIN
    ...
    (3, N''MUAF'', ''2026-07-27T00:00:00.0000000Z'', CAST(1 AS bit), CAST(1 AS bit), N''KDV Muafiyet'', 0.0, NULL)');
    IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'Code', N'CreatedAtUtc', N'IsActive', N'IsExempt', N'Name', N'Rate', N'UpdatedAtUtc') AND [object_id] = OBJECT_ID(N'[TaxRates]'))
...
BEGIN
    IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'Barcode', N'Brand', N'CategoryId', N'CreatedAtUtc', N'Description', N'ImagePath', N'IsActive', N'MinimumStockQuantity', N'Model', N'Name', N'ProductType', N'PurchasePrice', N'SalePrice', N'StockCode', N'StockQuantity', N'TaxRateId', N'TrackStock', N'Unit', N'UpdatedAtUtc', N'WebsitePath') AND [object_id] = OBJECT_ID(N'[Products]'))
        SET IDENTITY_INSERT [Products] ON;
    EXEC(N'INSERT INTO [Products] ([Id], [Barcode], [Brand], [CategoryId], [CreatedAtUtc], [Description], [ImagePath], [IsActive], [MinimumStockQuantity], [Model], [Name], [ProductType], [PurchasePrice], [SalePrice], [StockCode], [StockQuantity], [TaxRateId], [TrackStock], [Unit], [UpdatedAtUtc], [WebsitePath])
    VALUES (1, NULL, N''Ingenico'', 1, ''2026-07-27T00:00:00.0000000Z'', NULL, NULL, CAST(1 AS bit), 0.0, N''IDE280'', N''Ingenico IDE280'', N''Donanım'', 0.0, 0.0, N''YK-0001'', 0.0, 1, CAST(1 AS bit), N''Adet'', NULL, N''yazarkasa-pos.html''),
    (2, NULL, N''Ingenico'', 1, ''2026-07-27T00:00:00.0000000Z'', NULL, NULL, CAST(1 AS bit), 0.0, N''Move 5000F'', N''Ingenico Move 5000F'', N''Donanım'', 0.0, 0.0, N''YK-0002'', 0.0, 1, CAST(1 AS bit), N''Adet'', NULL, N''yazarkasa-pos.html''),
    (3, NULL, N''PayGo'', 1, ''2026-07-27T00:00:00.0000000Z'', NULL, NULL, CAST(1 AS bit), 0.0, N''SP630PRO ECR'', N''PAYGO SP630PRO ECR'', N''Donanım'', 0.0, 0.0, N''YK-0003'', 0.0, 1, CAST(1 AS bit), N''Adet'', NULL, N''yazarkasa-pos.html''),
    (4, NULL, N''Profilo'', 1, ''2026-07-27T00:00:00.0000000Z'', NULL, NULL, CAST(1 AS bit), 0.0, N''S900'', N''Profilo S900'', N''Donanım'', 0.0, 0.0, N''YK-0004'', 0.0, 1, CAST(1 AS bit), N''Adet'', NULL, N''yazarkasa-pos.html''),
    (5, NULL, N''inPOS'', 1, ''2026-07-27T00:00:00.0000000Z'', NULL, NULL, CAST(1 AS bit), 0.0, N''m530'', N''inPOS m530 Mobil POS'', N''Donanım'', 0.0, 0.0, N''YK-0005'', 0.0, 1, CAST(1 AS bit), N''Adet'', NULL, N''yazarkasa-pos.html''),
    (6, NULL, N''CAS'', 2, ''2026-07-27T00:00:00.0000000Z'', NULL, NULL, CAST(1 AS bit), 0.0, N''CL3000'', N''CAS CL3000 Market Terazisi'', N''Donanım'', 0.0, 0.0, N''TR-0001'', 0.0, 2, CAST(1 AS bit), N''Adet'', NULL, N''teraziler.html''),
    (7, NULL, N''CAS'', 2, ''2026-07-27T00:00:00.0000000Z'', NULL, NULL, CAST(1 AS bit), 0.0, N''CL8000'', N''CAS CL8000 Dokunmatik Terazi'', N''Donanım'', 0.0, 0.0, N''TR-0002'', 0.0, 2, CAST(1 AS bit), N''Adet'', NULL, N''teraziler.html''),
    (8, NULL, N''CAS'', 2, ''2026-07-27T00:00:00.0000000Z'', NULL, NULL, CAST(1 AS bit), 0.0, N''CN-1'', N''CAS CN-1 Sistem Terazisi'', N''Donanım'', 0.0, 0.0, N''TR-0003'', 0.0, 2, CAST(1 AS bit), N''Adet'', NULL, N''teraziler.html''),
    (9, NULL, N''Digi'', 2, ''2026-07-27T00:00:00.0000000Z'', NULL, NULL, CAST(1 AS bit), 0.0, N''SM100P'', N''Digi SM100P Boyunlu Terazi'', N''Donanım'', 0.0, 0.0, N''TR-0004'', 0.0, 2, CAST(1 AS bit), N''Adet'', NULL, N''teraziler.html''),
    (10, NULL, N''Digi'', 2, ''2026-07-27T00:00:00.0000000Z'', NULL, NULL, CAST(1 AS bit), 0.0, N''SM-120T'', N''Digi SM-120T Dokunmatik Terazi'', N''Donanım'', 0.0, 0.0, N''TR-0005'', 0.0, 2, CAST(1 AS bit), N''Adet'', NULL, N''teraziler.html''),
    (11, NULL, N''CAS'', 2, ''2026-07-27T00:00:00.0000000Z'', NULL, NULL, CAST(1 AS bit), 0.0, N''ER-JR'', N''CAS ER-JR Masaüstü Terazi'', N''Donanım'', 0.0, 0.0, N''TR-0006'', 0.0, 2, CAST(1 AS bit), N''Adet'', NULL, N''teraziler.html''),
    (12, NULL, N''CAS'', 2, ''2026-07-27T00:00:00.0000000Z'', NULL, NULL, CAST(1 AS bit), 0.0, N''FW-500'', N''CAS FW-500 Su Geçirmez Terazi'', N''Donanım'', 0.0, 0.0, N''TR-0007'', 0.0, 2, CAST(1 AS bit), N''Adet'', NULL, N''teraziler.html''),
    (13, NULL, N''CAS'', 2, ''2026-07-27T00:00:00.0000000Z'', NULL, NULL, CAST(1 AS bit), 0.0, N''PDI'', N''CAS PDI Ankastre Kasa Terazisi'', N''Donanım'', 0.0, 0.0, N''TR-0008'', 0.0, 2, CAST(1 AS bit), N''Adet'', NULL, N''teraziler.html''),
    (14, NULL, N''Hillpos'', 3, ''2026-07-27T00:00:00.0000000Z'', NULL, NULL, CAST(1 AS bit), 0.0, N''HRS-28'', N''Hillpos HRS-28'', N''Donanım'', 0.0, 0.0, N''BO-0001'', 0.0, 2, CAST(1 AS bit), N''Adet'', NULL, N''barkod-okuyucular.html''),
    (15, NULL, N''Hillpos'', 3, ''2026-07-27T00:00:00.0000000Z'', NULL, NULL, CAST(1 AS bit), 0.0, N''HSC-82'', N''Hillpos HSC-82'', N''Donanım'', 0.0, 0.0, N''BO-0002'', 0.0, 2, CAST(1 AS bit), N''Adet'', NULL, N''barkod-okuyucular.html''),
    (16, NULL, N''Hillpos'', 3, ''2026-07-27T00:00:00.0000000Z'', NULL, NULL, CAST(1 AS bit), 0.0, N''HSD-92'', N''Hillpos HSD-92'', N''Donanım'', 0.0, 0.0, N''BO-0003'', 0.0, 2, CAST(1 AS bit), N''Adet'', NULL, N''barkod-okuyucular.html''),
    (17, NULL, N''Newland'', 3, ''2026-07-27T00:00:00.0000000Z'', NULL, NULL, CAST(1 AS bit), 0.0, N''TP-13'', N''Newland TP-13'', N''Donanım'', 0.0, 0.0, N''BO-0004'', 0.0, 2, CAST(1 AS bit), N''Adet'', NULL, N''barkod-okuyucular.html''),
    (18, NULL, N''Newland'', 3, ''2026-07-27T00:00:00.0000000Z'', NULL, NULL, CAST(1 AS bit), 0.0, N''TP-14'', N''Newland TP-14'', N''Donanım'', 0.0, 0.0, N''BO-0005'', 0.0, 2, CAST(1 AS bit), N''Adet'', NULL, N''barkod-okuyucular.html''),
    (19, NULL, N''Hillpos'', 3, ''2026-07-27T00:00:00.0000000Z'', NULL, NULL, CAST(1 AS bit), 0.0, N''HS-6700'', N''Hillpos HS-6700'', N''Donanım'', 0.0, 0.0, N''BO-0006'', 0.0, 2, CAST(1 AS bit), N''Adet'', NULL, N''barkod-okuyucular.html''),
    (20, NULL, N''Hillpos'', 3, ''2026-07-27T00:00:00.0000000Z'', NULL, NULL, CAST(1 AS bit), 0.0, N''VS-6800'', N''Hillpos VS-6800'', N''Donanım'', 0.0, 0.0, N''BO-0007'', 0.0, 2, CAST(1 AS bit), N''Adet'', NULL, N''barkod-okuyucular.html''),
    (21, NULL, N''Argox'', 4, ''2026-07-27T00:00:00.0000000Z'', NULL, NULL, CAST(1 AS bit), 0.0, N''OS-214 Plus'', N''Argox OS-214 Plus Barkod Yazıcı'', N''Donanım'', 0.0, 0.0, N''YZ-0001'', 0.0, 2, CAST(1 AS bit), N''Adet'', NULL, N''yazicilar.html''),
    (22, NULL, N''Hillpos'', 4, ''2026-07-27T00:00:00.0000000Z'', NULL, NULL, CAST(1 AS bit), 0.0, N''HDT-400'', N''Hillpos HDT-400 Barkod Yazıcı'', N''Donanım'', 0.0, 0.0, N''YZ-0002'', 0.0, 2, CAST(1 AS bit), N''Adet'', NULL, N''yazicilar.html''),
    (23, NULL, N''Hillpos'', 4, ''2026-07-27T00:00:00.0000000Z'', NULL, NULL, CAST(1 AS bit), 0.0, N''HTT-440'', N''Hillpos HTT-440 Barkod Yazıcı'', N''Donanım'', 0.0, 0.0, N''YZ-0003'', 0.0, 2, CAST(1 AS bit), N''Adet'', NULL, N''yazicilar.html''),
    (24, NULL, N''TSC'', 4, ''2026-07-27T00:00:00.0000000Z'', NULL, NULL, CAST(1 AS bit), 0.0, N''TTP-244CE'', N''TSC TTP-244CE Barkod Yazıcı'', N''Donanım'', 0.0, 0.0, N''YZ-0004'', 0.0, 2, CAST(1 AS bit), N''Adet'', NULL, N''yazicilar.html''),
    (25, NULL, N''Xprinter'', 4, ''2026-07-27T00:00:00.0000000Z'', NULL, NULL, CAST(1 AS bit), 0.0, N''XP-470B'', N''Xprinter XP-470B Barkod Yazıcı'', N''Donanım'', 0.0, 0.0, N''YZ-0005'', 0.0, 2, CAST(1 AS bit), N''Adet'', NULL, N''yazicilar.html''),
    (26, NULL, N''Hillpos'', 4, ''2026-07-27T00:00:00.0000000Z'', NULL, NULL, CAST(1 AS bit), 0.0, N''H380'', N''Hillpos H380 Fiş Yazıcı'', N''Donanım'', 0.0, 0.0, N''YZ-0006'', 0.0, 2, CAST(1 AS bit), N''Adet'', NULL, N''yazicilar.html''),
    (27, NULL, N''Hillpos'', 4, ''2026-07-27T00:00:00.0000000Z'', NULL, NULL, CAST(1 AS bit), 0.0, N''Q800'', N''Hillpos Q800 Fiş Yazıcı'', N''Donanım'', 0.0, 0.0, N''YZ-0007'', 0.0, 2, CAST(1 AS bit), N''Adet'', NULL, N''yazicilar.html''),
    (28, NULL, N''Bixolon'', 4, ''2026-07-27T00:00:00.0000000Z'', NULL, NULL, CAST(1 AS bit), 0.0, N''SPP-R310'', N''Bixolon SPP-R310 Mobil Fiş Yazıcı'', N''Donanım'', 0.0, 0.0, N''YZ-0008'', 0.0, 2, CAST(1 AS bit), N''Adet'', NULL, N''yazicilar.html''),
    (29, NULL, N''Chainway'', 5, ''2026-07-27T00:00:00.0000000Z'', NULL, NULL, CAST(1 AS bit), 0.0, N''C61'', N''Chainway C61'', N''Donanım'', 0.0, 0.0, N''ET-0001'', 0.0, 2, CAST(1 AS bit), N''Adet'', NULL, N''el-terminali.html''),
    (30, NULL, N''Chainway'', 5, ''2026-07-27T00:00:00.0000000Z'', NULL, NULL, CAST(1 AS bit), 0.0, N''C66'', N''Chainway C66'', N''Donanım'', 0.0, 0.0, N''ET-0002'', 0.0, 2, CAST(1 AS bit), N''Adet'', NULL, N''el-terminali.html''),
    (31, NULL, N''Hillpos'', 5, ''2026-07-27T00:00:00.0000000Z'', NULL, NULL, CAST(1 AS bit), 0.0, N''C7X'', N''Hillpos C7X Tablet'', N''Donanım'', 0.0, 0.0, N''ET-0003'', 0.0, 2, CAST(1 AS bit), N''Adet'', NULL, N''el-terminali.html''),
    (32, NULL, N''Hillpos'', 5, ''2026-07-27T00:00:00.0000000Z'', NULL, NULL, CAST(1 AS bit), 0.0, N''CM550X'', N''Hillpos CM550X'', N''Donanım'', 0.0, 0.0, N''ET-0004'', 0.0, 2, CAST(1 AS bit), N''Adet'', NULL, N''el-terminali.html''),
    (33, NULL, N''Hillpos'', 5, ''2026-07-27T00:00:00.0000000Z'', NULL, NULL, CAST(1 AS bit), 0.0, N''HT42'', N''Hillpos HT42'', N''Donanım'', 0.0, 0.0, N''ET-0005'', 0.0, 2, CAST(1 AS bit), N''Adet'', NULL, N''el-terminali.html''),
    (34, NULL, N''Hillpos'', 5, ''2026-07-27T00:00:00.0000000Z'', NULL, NULL, CAST(1 AS bit), 0.0, N''HT42K'', N''Hillpos HT42K'', N''Donanım'', 0.0, 0.0, N''ET-0006'', 0.0, 2, CAST(1 AS bit), N''Adet'', NULL, N''el-terminali.html''),
    (35, NULL, N''Hillpos'', 5, ''2026-07-27T00:00:00.0000000Z'', NULL, NULL, CAST(1 AS bit), 0.0, N''HT44'', N''Hillpos HT44'', N''Donanım'', 0.0, 0.0, N''ET-0007'', 0.0, 2, CAST(1 AS bit), N''Adet'', NULL, N''el-terminali.html''),
    (36, NULL, N''Hillpos'', 6, ''2026-07-27T00:00:00.0000000Z'', NULL, NULL, CAST(1 AS bit), 0.0, N''Touch Pro 15'', N''Hillpos Touch Pro 15'', N''Donanım'', 0.0, 0.0, N''PC-0001'', 0.0, 2, CAST(1 AS bit), N''Adet'', NULL, N''dokunmatik-pos.html''),
    (37, NULL, N''Hillpos'', 6, ''2026-07-27T00:00:00.0000000Z'', NULL, NULL, CAST(1 AS bit), 0.0, N''All-in-One Dual POS'', N''Hillpos All-in-One Dual POS'', N''Donanım'', 0.0, 0.0, N''PC-0002'', 0.0, 2, CAST(1 AS bit), N''Adet'', NULL, N''dokunmatik-pos.html''),
    (38, NULL, N''Hillpos'', 6, ''2026-07-27T00:00:00.0000000Z'', NULL, NULL, CAST(1 AS bit), 0.0, N''Slim Touch 15'', N''Hillpos Slim Touch 15'', N''Donanım'', 0.0, 0.0, N''PC-0003'', 0.0, 2, CAST(1 AS bit), N''Adet'', NULL, N''dokunmatik-pos.html''),
    (39, NULL, N''Hillpos'', 6, ''2026-07-27T00:00:00.0000000Z'', NULL, NULL, CAST(1 AS bit), 0.0, N''Kiosk POS 21.5'', N''Hillpos Kiosk POS 21.5'', N''Donanım'', 0.0, 0.0, N''PC-0004'', 0.0, 2, CAST(1 AS bit), N''Adet'', NULL, N''dokunmatik-pos.html''),
    (40, NULL, NULL, 7, ''2026-07-27T00:00:00.0000000Z'', NULL, NULL, CAST(1 AS bit), 0.0, NULL, N''Özel ERP & CRM Yazılımları'', N''Yazılım'', 0.0, 0.0, N''YW-0001'', 0.0, 3, CAST(0 AS bit), N''Adet'', NULL, N''kurumsal-yazilim.html''),
    (41, NULL, NULL, 7, ''2026-07-27T00:00:00.0000000Z'', NULL, NULL, CAST(1 AS bit), 0.0, NULL, N''Stok ve Depo Yönetimi Yazılımı'', N''Yazılım'', 0.0, 0.0, N''YW-0002'', 0.0, 3, CAST(0 AS bit), N''Adet'', NULL, N''kurumsal-yazilim.html''),
    (42, NULL, NULL, 7, ''2026-07-27T00:00:00.0000000Z'', NULL, NULL, CAST(1 AS bit), 0.0, NULL, N''Fabrika ve Üretim Takibi Yazılımı'', N''Yazılım'', 0.0, 0.0, N''YW-0003'', 0.0, 3, CAST(0 AS bit), N''Adet'', NULL, N''kurumsal-yazilim.html'');
    INSERT INTO [Products] ([Id], [Barcode], [Brand], [CategoryId], [CreatedAtUtc], [Description], [ImagePath], [IsActive], [MinimumStockQuantity], [Model], [Name], [ProductType], [PurchasePrice], [SalePrice], [StockCode], [StockQuantity], [TaxRateId], [TrackStock], [Unit], [UpdatedAtUtc], [WebsitePath])
    VALUES (43, NULL, NULL, 7, ''2026-07-27T00:00:00.0000000Z'', NULL, NULL, CAST(1 AS bit), 0.0, NULL, N''API ve Donanım Entegrasyonları'', N''Yazılım'', 0.0, 0.0, N''YW-0004'', 0.0, 3, CAST(0 AS bit), N''Adet'', NULL, N''kurumsal-yazilim.html''),
    (44, NULL, NULL, 7, ''2026-07-27T00:00:00.0000000Z'', NULL, NULL, CAST(1 AS bit), 0.0, NULL, N''GİB & E-Fatura Çözümleri'', N''Yazılım'', 0.0, 0.0, N''YW-0005'', 0.0, 3, CAST(0 AS bit), N''Adet'', NULL, N''kurumsal-yazilim.html'')');
    IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'Barcode', N'Brand', N'CategoryId', N'CreatedAtUtc', N'Description', N'ImagePath', N'IsActive', N'MinimumStockQuantity', N'Model', N'Name', N'ProductType', N'PurchasePrice', N'SalePrice', N'StockCode', N'StockQuantity', N'TaxRateId', N'TrackStock', N'Unit', N'UpdatedAtUtc', N'WebsitePath') AND [object_id] = OBJECT_ID(N'[Products]'))
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260727182158_AddCatalogAndWebsiteProducts', N'10.0.10');
END;
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260727182243_AddRemainingWebsiteProducts'
)
BEGIN
    IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'Code', N'CreatedAtUtc', N'IsActive', N'Name', N'UpdatedAtUtc', N'WebsitePath') AND [object_id] = OBJECT_ID(N'[ProductCategories]'))
        SET IDENTITY_INSERT [ProductCategories] ON;
    EXEC(N'INSERT INTO [ProductCategories] ([Id], [Code], [CreatedAtUtc], [IsActive], [Name], [UpdatedAtUtc], [WebsitePath])
    VALUES (8, N''POSEKIP'', ''2026-07-27T00:00:00.0000000Z'', CAST(1 AS bit), N''POS Çevre Birimleri'', NULL, N''index.html'')');
    IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'Code', N'CreatedAtUtc', N'IsActive', N'Name', N'UpdatedAtUtc', N'WebsitePath') AND [object_id] = OBJECT_ID(N'[ProductCategories]'))
        SET IDENTITY_INSERT [ProductCategories] OFF;
END;
...
BEGIN
    IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'Barcode', N'Brand', N'CategoryId', N'CreatedAtUtc', N'Description', N'ImagePath', N'IsActive', N'MinimumStockQuantity', N'Model', N'Name', N'ProductType', N'PurchasePrice', N'SalePrice', N'StockCode', N'StockQuantity', N'TaxRateId', N'TrackStock', N'Unit', N'UpdatedAtUtc', N'WebsitePath') AND [object_id] = OBJECT_ID(N'[Products]'))
        SET IDENTITY_INSERT [Products] ON;
    EXEC(N'INSERT INTO [Products] ([Id], [Barcode], [Brand], [CategoryId], [CreatedAtUtc], [Description], [ImagePath], [IsActive], [MinimumStockQuantity], [Model], [Name], [ProductType], [PurchasePrice], [SalePrice], [StockCode], [StockQuantity], [TaxRateId], [TrackStock], [Unit], [UpdatedAtUtc], [WebsitePath])
    VALUES (45, NULL, N''Genel'', 8, ''2026-07-27T00:00:00.0000000Z'', NULL, NULL, CAST(1 AS bit), 0.0, N''Metal Kasa'', N''Para Çekmecesi'', N''Donanım'', 0.0, 0.0, N''PE-0001'', 0.0, 2, CAST(1 AS bit), N''Adet'', NULL, N''index.html''),
    (46, NULL, N''Genel'', 8, ''2026-07-27T00:00:00.0000000Z'', NULL, NULL, CAST(1 AS bit), 0.0, N''Fiyat Sorgulama Terminali'', N''Fiyat Gör Cihazı'', N''Donanım'', 0.0, 0.0, N''PE-0002'', 0.0, 2, CAST(1 AS bit), N''Adet'', NULL, N''index.html''),
    (47, NULL, N''Genel'', 8, ''2026-07-27T00:00:00.0000000Z'', NULL, NULL, CAST(1 AS bit), 0.0, N''Mobil Fiş Yazıcı'', N''Mobil Yazıcı'', N''Donanım'', 0.0, 0.0, N''PE-0003'', 0.0, 2, CAST(1 AS bit), N''Adet'', NULL, N''index.html'')');
    IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'Barcode', N'Brand', N'CategoryId', N'CreatedAtUtc', N'Description', N'ImagePath', N'IsActive', N'MinimumStockQuantity', N'Model', N'Name', N'ProductType', N'PurchasePrice', N'SalePrice', N'StockCode', N'StockQuantity', N'TaxRateId', N'TrackStock', N'Unit', N'UpdatedAtUtc', N'WebsitePath') AND [object_id] = OBJECT_ID(N'[Products]'))
        SET IDENTITY_INSERT [Products] OFF;
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260727182243_AddRemainingWebsiteProducts', N'10.0.10');
END;
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260727182647_UpdateTaxRates'
)
BEGIN
    EXEC(N'UPDATE [TaxRates] SET [Code] = N''KDV0'', [Name] = N''KDV %0''
    WHERE [Id] = 3;
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'Code', N'CreatedAtUtc', N'IsActive', N'IsExempt', N'Name', N'Rate', N'UpdatedAtUtc') AND [object_id] = OBJECT_ID(N'[TaxRates]'))
        SET IDENTITY_INSERT [TaxRates] ON;
    EXEC(N'INSERT INTO [TaxRates] ([Id], [Code], [CreatedAtUtc], [IsActive], [IsExempt], [Name], [Rate], [UpdatedAtUtc])
    VALUES (4, N''KDV1'', ''2026-07-27T00:00:00.0000000Z'', CAST(1 AS bit), CAST(0 AS bit), N''KDV %1'', 1.0, NULL)');
    IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'Code', N'CreatedAtUtc', N'IsActive', N'IsExempt', N'Name', N'Rate', N'UpdatedAtUtc') AND [object_id] = OBJECT_ID(N'[TaxRates]'))
        SET IDENTITY_INSERT [TaxRates] OFF;
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260727182647_UpdateTaxRates', N'10.0.10');
END;
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260727183137_AddConnectedBusinessCore'
)
BEGIN
    ALTER TABLE [TaxRates] ADD [RowVersion] rowversion NOT NULL;
END;
...
BEGIN
    ALTER TABLE [ProductCategories] ADD [RowVersion] rowversion NOT NULL;
END;
...
BEGIN
    IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'Code', N'CreatedAtUtc', N'IsActive', N'IsDefault', N'Name', N'UpdatedAtUtc') AND [object_id] = OBJECT_ID(N'[Warehouses]'))
        SET IDENTITY_INSERT [Warehouses] ON;
    EXEC(N'INSERT INTO [Warehouses] ([Id], [Code], [CreatedAtUtc], [IsActive], [IsDefault], [Name], [UpdatedAtUtc])
    VALUES (1, N''MERKEZ'', ''2026-07-27T00:00:00.0000000Z'', CAST(1 AS bit), CAST(1 AS bit), N''Merkez Depo'', NULL)');
    IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'Code', N'CreatedAtUtc', N'IsActive', N'IsDefault', N'Name', N'UpdatedAtUtc') AND [object_id] = OBJECT_ID(N'[Warehouses]'))
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260727183137_AddConnectedBusinessCore', N'10.0.10');
END;
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260727183946_AddReceiptsAndBusinessDimensions'
)
BEGIN
    ALTER TABLE [StockMovements] ADD [BusinessProjectId] int NULL;
END;
...
BEGIN
    ALTER TABLE [StockMovements] ADD [CostCenterId] int NULL;
END;
...
BEGIN
    ALTER TABLE [Invoices] ADD [BusinessProjectId] int NULL;
END;
...
BEGIN
    ALTER TABLE [Invoices] ADD [CostCenterId] int NULL;
END;
...
BEGIN
    ALTER TABLE [Invoices] ADD CONSTRAINT [FK_Invoices_BusinessProjects_BusinessProjectId] FOREIGN KEY ([BusinessProjectId]) REFERENCES [BusinessProjects] ([Id]) ON DELETE SET NULL;
END;
...
BEGIN
    ALTER TABLE [Invoices] ADD CONSTRAINT [FK_Invoices_CostCenters_CostCenterId] FOREIGN KEY ([CostCenterId]) REFERENCES [CostCenters] ([Id]) ON DELETE SET NULL;
END;
...
BEGIN
    ALTER TABLE [StockMovements] ADD CONSTRAINT [FK_StockMovements_BusinessProjects_BusinessProjectId] FOREIGN KEY ([BusinessProjectId]) REFERENCES [BusinessProjects] ([Id]) ON DELETE SET NULL;
END;
...
BEGIN
    ALTER TABLE [StockMovements] ADD CONSTRAINT [FK_StockMovements_CostCenters_CostCenterId] FOREIGN KEY ([CostCenterId]) REFERENCES [CostCenters] ([Id]) ON DELETE SET NULL;
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260727183946_AddReceiptsAndBusinessDimensions', N'10.0.10');
END;
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260727184243_AddAdvancedInventory'
)
BEGIN
    ALTER TABLE [Warehouses] ADD [BranchId] int NOT NULL DEFAULT 0;
END;
...
BEGIN
    ALTER TABLE [StockMovements] ADD [ProductVariantId] int NULL;
END;
...
BEGIN
    ALTER TABLE [StockMovements] ADD [StockTransferLineId] int NULL;
END;
...
BEGIN
    EXEC(N'UPDATE [Warehouses] SET [BranchId] = 1
    WHERE [Id] = 1;
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'ALTER TABLE [Products] ADD CONSTRAINT [CK_Products_Prices] CHECK ([PurchasePrice] >= 0 AND [SalePrice] >= 0)');
END;
...
BEGIN
    EXEC(N'ALTER TABLE [Products] ADD CONSTRAINT [CK_Products_Quantities] CHECK ([StockQuantity] >= 0 AND [MinimumStockQuantity] >= 0)');
END;
...
BEGIN
    ALTER TABLE [StockMovements] ADD CONSTRAINT [FK_StockMovements_ProductVariants_ProductVariantId] FOREIGN KEY ([ProductVariantId]) REFERENCES [ProductVariants] ([Id]) ON DELETE SET NULL;
END;
...
BEGIN
    ALTER TABLE [StockMovements] ADD CONSTRAINT [FK_StockMovements_StockTransferLines_StockTransferLineId] FOREIGN KEY ([StockTransferLineId]) REFERENCES [StockTransferLines] ([Id]) ON DELETE SET NULL;
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260727184243_AddAdvancedInventory', N'10.0.10');
END;
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260727184849_AddBarcodeScaleAndInventoryPolicies'
)
BEGIN
...
BEGIN
    IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'AllowNegativeStock', N'AllowSaleBelowCost', N'AllowSaleWhenOutOfStock', N'AutoGenerateBarcode', N'CreatedAtUtc', N'DefaultBarcodeType', N'DefaultScalePrefix', N'EnableMinimumStockWarning', N'EnforceStockLevel', N'RequireBarcode', N'RequireTransferApproval', N'TrackStockByVariant', N'UpdatedAtUtc') AND [object_id] = OBJECT_ID(N'[InventorySettings]'))
        SET IDENTITY_INSERT [InventorySettings] ON;
    EXEC(N'INSERT INTO [InventorySettings] ([Id], [AllowNegativeStock], [AllowSaleBelowCost], [AllowSaleWhenOutOfStock], [AutoGenerateBarcode], [CreatedAtUtc], [DefaultBarcodeType], [DefaultScalePrefix], [EnableMinimumStockWarning], [EnforceStockLevel], [RequireBarcode], [RequireTransferApproval], [TrackStockByVariant], [UpdatedAtUtc])
    VALUES (1, CAST(0 AS bit), CAST(0 AS bit), CAST(0 AS bit), CAST(1 AS bit), ''2026-07-27T00:00:00.0000000Z'', N''EAN13'', N''27'', CAST(1 AS bit), CAST(1 AS bit), CAST(1 AS bit), CAST(1 AS bit), CAST(1 AS bit), NULL)');
    IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'AllowNegativeStock', N'AllowSaleBelowCost', N'AllowSaleWhenOutOfStock', N'AutoGenerateBarcode', N'CreatedAtUtc', N'DefaultBarcodeType', N'DefaultScalePrefix', N'EnableMinimumStockWarning', N'EnforceStockLevel', N'RequireBarcode', N'RequireTransferApproval', N'TrackStockByVariant', N'UpdatedAtUtc') AND [object_id] = OBJECT_ID(N'[InventorySettings]'))
...
BEGIN
    EXEC(N'UPDATE [Products] SET [Barcode] = N''2000000000015''
    WHERE [Id] = 1;
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [Products] SET [Barcode] = N''2000000000022''
    WHERE [Id] = 2;
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [Products] SET [Barcode] = N''2000000000039''
    WHERE [Id] = 3;
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [Products] SET [Barcode] = N''2000000000046''
    WHERE [Id] = 4;
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [Products] SET [Barcode] = N''2000000000053''
    WHERE [Id] = 5;
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [Products] SET [Barcode] = N''2000000000060''
    WHERE [Id] = 6;
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [Products] SET [Barcode] = N''2000000000077''
    WHERE [Id] = 7;
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [Products] SET [Barcode] = N''2000000000084''
    WHERE [Id] = 8;
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [Products] SET [Barcode] = N''2000000000091''
    WHERE [Id] = 9;
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [Products] SET [Barcode] = N''2000000000107''
    WHERE [Id] = 10;
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [Products] SET [Barcode] = N''2000000000114''
    WHERE [Id] = 11;
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [Products] SET [Barcode] = N''2000000000121''
    WHERE [Id] = 12;
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [Products] SET [Barcode] = N''2000000000138''
    WHERE [Id] = 13;
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [Products] SET [Barcode] = N''2000000000145''
    WHERE [Id] = 14;
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [Products] SET [Barcode] = N''2000000000152''
    WHERE [Id] = 15;
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [Products] SET [Barcode] = N''2000000000169''
    WHERE [Id] = 16;
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [Products] SET [Barcode] = N''2000000000176''
    WHERE [Id] = 17;
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [Products] SET [Barcode] = N''2000000000183''
    WHERE [Id] = 18;
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [Products] SET [Barcode] = N''2000000000190''
    WHERE [Id] = 19;
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [Products] SET [Barcode] = N''2000000000206''
    WHERE [Id] = 20;
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [Products] SET [Barcode] = N''2000000000213''
    WHERE [Id] = 21;
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [Products] SET [Barcode] = N''2000000000220''
    WHERE [Id] = 22;
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [Products] SET [Barcode] = N''2000000000237''
    WHERE [Id] = 23;
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [Products] SET [Barcode] = N''2000000000244''
    WHERE [Id] = 24;
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [Products] SET [Barcode] = N''2000000000251''
    WHERE [Id] = 25;
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [Products] SET [Barcode] = N''2000000000268''
    WHERE [Id] = 26;
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [Products] SET [Barcode] = N''2000000000275''
    WHERE [Id] = 27;
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [Products] SET [Barcode] = N''2000000000282''
    WHERE [Id] = 28;
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [Products] SET [Barcode] = N''2000000000299''
    WHERE [Id] = 29;
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [Products] SET [Barcode] = N''2000000000305''
    WHERE [Id] = 30;
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [Products] SET [Barcode] = N''2000000000312''
    WHERE [Id] = 31;
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [Products] SET [Barcode] = N''2000000000329''
    WHERE [Id] = 32;
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [Products] SET [Barcode] = N''2000000000336''
    WHERE [Id] = 33;
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [Products] SET [Barcode] = N''2000000000343''
    WHERE [Id] = 34;
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [Products] SET [Barcode] = N''2000000000350''
    WHERE [Id] = 35;
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [Products] SET [Barcode] = N''2000000000367''
    WHERE [Id] = 36;
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [Products] SET [Barcode] = N''2000000000374''
    WHERE [Id] = 37;
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [Products] SET [Barcode] = N''2000000000381''
    WHERE [Id] = 38;
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [Products] SET [Barcode] = N''2000000000398''
    WHERE [Id] = 39;
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [Products] SET [Barcode] = N''2000000000404''
    WHERE [Id] = 40;
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [Products] SET [Barcode] = N''2000000000411''
    WHERE [Id] = 41;
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [Products] SET [Barcode] = N''2000000000428''
    WHERE [Id] = 42;
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [Products] SET [Barcode] = N''2000000000435''
    WHERE [Id] = 43;
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [Products] SET [Barcode] = N''2000000000442''
    WHERE [Id] = 44;
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [Products] SET [Barcode] = N''2000000000459''
    WHERE [Id] = 45;
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [Products] SET [Barcode] = N''2000000000466''
    WHERE [Id] = 46;
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [Products] SET [Barcode] = N''2000000000473''
    WHERE [Id] = 47;
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'ALTER TABLE [ProductBarcodes] ADD CONSTRAINT [CK_ProductBarcodes_Length] CHECK (([BarcodeType] = N''EAN13'' AND LEN([Barcode]) = 13) OR ([BarcodeType] = N''EAN8'' AND LEN([Barcode]) = 8) OR ([BarcodeType] = N''SCALE'' AND LEN([Barcode]) = 7) OR [BarcodeType] = N''OTHER'')');
END;
...
BEGIN
    EXEC(N'ALTER TABLE [ProductBarcodes] ADD CONSTRAINT [CK_ProductBarcodes_Numeric] CHECK ([BarcodeType] = N''OTHER'' OR [Barcode] NOT LIKE ''%[^0-9]%'')');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260727184849_AddBarcodeScaleAndInventoryPolicies', N'10.0.10');
END;
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260727185749_CompleteIntegratedPreAccountingCore'
)
BEGIN
    ALTER TABLE [Products] DROP CONSTRAINT [CK_Products_Quantities];
END;
...
BEGIN
    ALTER TABLE [Warehouses] ADD [RecordId] uniqueidentifier NOT NULL DEFAULT (NEWSEQUENTIALID());
END;
...
BEGIN
    ALTER TABLE [TaxRates] ADD [RecordId] uniqueidentifier NOT NULL DEFAULT (NEWSEQUENTIALID());
END;
...
BEGIN
    ALTER TABLE [StockTransfers] ADD [RecordId] uniqueidentifier NOT NULL DEFAULT (NEWSEQUENTIALID());
END;
...
BEGIN
    ALTER TABLE [StockTransferLines] ADD [RecordId] uniqueidentifier NOT NULL DEFAULT (NEWSEQUENTIALID());
END;
...
BEGIN
    ALTER TABLE [StockMovements] ADD [InventoryCountLineId] int NULL;
END;
...
BEGIN
    ALTER TABLE [StockMovements] ADD [RecordId] uniqueidentifier NOT NULL DEFAULT (NEWSEQUENTIALID());
END;
...
BEGIN
    ALTER TABLE [StockMovements] ADD [StockSlipLineId] int NULL;
END;
...
BEGIN
    ALTER TABLE [ScaleProductSettings] ADD [RecordId] uniqueidentifier NOT NULL DEFAULT (NEWSEQUENTIALID());
END;
...
BEGIN
    ALTER TABLE [Quotes] ADD [RecordId] uniqueidentifier NOT NULL DEFAULT (NEWSEQUENTIALID());
END;
...
BEGIN
    ALTER TABLE [QuoteLines] ADD [RecordId] uniqueidentifier NOT NULL DEFAULT (NEWSEQUENTIALID());
END;
...
BEGIN
    ALTER TABLE [PurchasePriceLists] ADD [RecordId] uniqueidentifier NOT NULL DEFAULT (NEWSEQUENTIALID());
END;
...
BEGIN
    ALTER TABLE [PurchasePriceListItems] ADD [RecordId] uniqueidentifier NOT NULL DEFAULT (NEWSEQUENTIALID());
END;
...
BEGIN
    ALTER TABLE [ProductVariants] ADD [RecordId] uniqueidentifier NOT NULL DEFAULT (NEWSEQUENTIALID());
END;
...
BEGIN
    ALTER TABLE [Products] ADD [RecordId] uniqueidentifier NOT NULL DEFAULT (NEWSEQUENTIALID());
END;
...
BEGIN
    ALTER TABLE [Products] ADD [TrackLots] bit NOT NULL DEFAULT CAST(0 AS bit);
END;
...
BEGIN
    ALTER TABLE [Products] ADD [TrackSerialNumbers] bit NOT NULL DEFAULT CAST(0 AS bit);
END;
...
BEGIN
    ALTER TABLE [ProductImages] ADD [RecordId] uniqueidentifier NOT NULL DEFAULT (NEWSEQUENTIALID());
END;
...
BEGIN
    ALTER TABLE [ProductColors] ADD [RecordId] uniqueidentifier NOT NULL DEFAULT (NEWSEQUENTIALID());
END;
...
BEGIN
    ALTER TABLE [ProductCategories] ADD [RecordId] uniqueidentifier NOT NULL DEFAULT (NEWSEQUENTIALID());
END;
...
BEGIN
    ALTER TABLE [ProductBarcodes] ADD [RecordId] uniqueidentifier NOT NULL DEFAULT (NEWSEQUENTIALID());
END;
...
BEGIN
    ALTER TABLE [PaymentReceipts] ADD [RecordId] uniqueidentifier NOT NULL DEFAULT (NEWSEQUENTIALID());
END;
...
BEGIN
    ALTER TABLE [PaymentReceiptLines] ADD [RecordId] uniqueidentifier NOT NULL DEFAULT (NEWSEQUENTIALID());
END;
...
BEGIN
    ALTER TABLE [NumberSequences] ADD [RecordId] uniqueidentifier NOT NULL DEFAULT (NEWSEQUENTIALID());
END;
...
BEGIN
    ALTER TABLE [Invoices] ADD [RecordId] uniqueidentifier NOT NULL DEFAULT (NEWSEQUENTIALID());
END;
...
BEGIN
    ALTER TABLE [Invoices] ADD [WarehouseId] int NOT NULL DEFAULT 1;
END;
...
BEGIN
    ALTER TABLE [InvoiceLines] ADD [RecordId] uniqueidentifier NOT NULL DEFAULT (NEWSEQUENTIALID());
END;
...
BEGIN
    ALTER TABLE [InventorySettings] ADD [RecordId] uniqueidentifier NOT NULL DEFAULT (NEWSEQUENTIALID());
END;
...
BEGIN
    ALTER TABLE [FinancialTransactions] ADD [RecordId] uniqueidentifier NOT NULL DEFAULT (NEWSEQUENTIALID());
END;
...
BEGIN
    ALTER TABLE [FinancialAccounts] ADD [RecordId] uniqueidentifier NOT NULL DEFAULT (NEWSEQUENTIALID());
END;
...
BEGIN
    ALTER TABLE [Customers] ADD [RecordId] uniqueidentifier NOT NULL DEFAULT (NEWSEQUENTIALID());
END;
...
BEGIN
    ALTER TABLE [CustomerContacts] ADD [RecordId] uniqueidentifier NOT NULL DEFAULT (NEWSEQUENTIALID());
END;
...
BEGIN
    ALTER TABLE [CustomerAddresses] ADD [RecordId] uniqueidentifier NOT NULL DEFAULT (NEWSEQUENTIALID());
END;
...
BEGIN
    ALTER TABLE [CurrentAccountTransactions] ADD [RecordId] uniqueidentifier NOT NULL DEFAULT (NEWSEQUENTIALID());
END;
...
BEGIN
    ALTER TABLE [CostCenters] ADD [RecordId] uniqueidentifier NOT NULL DEFAULT (NEWSEQUENTIALID());
END;
...
BEGIN
    ALTER TABLE [CompanySettings] ADD [RecordId] uniqueidentifier NOT NULL DEFAULT (NEWSEQUENTIALID());
END;
...
BEGIN
    ALTER TABLE [BusinessProjects] ADD [RecordId] uniqueidentifier NOT NULL DEFAULT (NEWSEQUENTIALID());
END;
...
BEGIN
    ALTER TABLE [Branches] ADD [RecordId] uniqueidentifier NOT NULL DEFAULT (NEWSEQUENTIALID());
END;
...
BEGIN
    ALTER TABLE [AuditLogs] ADD [RecordId] uniqueidentifier NOT NULL DEFAULT (NEWSEQUENTIALID());
END;
...
BEGIN
    EXEC(N'UPDATE [CompanySettings] SET 
    WHERE [Id] = 1;
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [InventorySettings] SET 
    WHERE [Id] = 1;
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [NumberSequences] SET 
    WHERE [Id] = 1;
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [ProductBarcodes] SET 
    WHERE [Id] = 1;
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [ProductCategories] SET 
    WHERE [Id] = 1;
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [Products] SET [TrackLots] = CAST(0 AS bit), [TrackSerialNumbers] = CAST(0 AS bit)
    WHERE [Id] = 1;
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'ALTER TABLE [Quotes] ADD CONSTRAINT [CK_Quotes_Totals] CHECK ([Subtotal] >= 0 AND [DiscountTotal] >= 0 AND [TaxTotal] >= 0 AND [GrandTotal] >= 0)');
END;
...
BEGIN
    EXEC(N'ALTER TABLE [Products] ADD CONSTRAINT [CK_Products_Quantities] CHECK ([MinimumStockQuantity] >= 0)');
END;
...
BEGIN
    EXEC(N'ALTER TABLE [Invoices] ADD CONSTRAINT [CK_Invoices_Totals] CHECK ([Subtotal] >= 0 AND [DiscountTotal] >= 0 AND [TaxTotal] >= 0 AND [GrandTotal] >= 0)');
END;
...
BEGIN
    EXEC(N'ALTER TABLE [CurrentAccountTransactions] ADD CONSTRAINT [CK_CurrentAccountTransactions_DebitCredit] CHECK (([Debit] > 0 AND [Credit] = 0) OR ([Credit] > 0 AND [Debit] = 0))');
END;
...
BEGIN
    ALTER TABLE [StockMovements] ADD CONSTRAINT [FK_StockMovements_InventoryCountLines_InventoryCountLineId] FOREIGN KEY ([InventoryCountLineId]) REFERENCES [InventoryCountLines] ([Id]) ON DELETE SET NULL;
END;
...
BEGIN
    ALTER TABLE [StockMovements] ADD CONSTRAINT [FK_StockMovements_StockSlipLines_StockSlipLineId] FOREIGN KEY ([StockSlipLineId]) REFERENCES [StockSlipLines] ([Id]) ON DELETE SET NULL;
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260727185749_CompleteIntegratedPreAccountingCore', N'10.0.10');
END;
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260727190945_AddOptionalProductVariantPolicy'
)
BEGIN
    ALTER TABLE [InvoiceLines] ADD [ProductVariantId] int NULL;
END;
...
BEGIN
    ALTER TABLE [InventorySettings] ADD [RequireProductVariant] bit NOT NULL DEFAULT CAST(0 AS bit);
END;
...
BEGIN
    EXEC(N'UPDATE [InventorySettings] SET [RequireProductVariant] = CAST(0 AS bit)
    WHERE [Id] = 1;
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    ALTER TABLE [InvoiceLines] ADD CONSTRAINT [FK_InvoiceLines_ProductVariants_ProductVariantId] FOREIGN KEY ([ProductVariantId]) REFERENCES [ProductVariants] ([Id]) ON DELETE SET NULL;
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260727190945_AddOptionalProductVariantPolicy', N'10.0.10');
END;
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260727191204_DisableVariantTrackingByDefault'
)
BEGIN
    EXEC(N'UPDATE [InventorySettings] SET [TrackStockByVariant] = CAST(0 AS bit)
    WHERE [Id] = 1;
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260727191204_DisableVariantTrackingByDefault', N'10.0.10');
END;
